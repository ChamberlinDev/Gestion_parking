            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <form class="row g-3 needs-validation" novalidate action="/registre_save" method="POST">
                    @csrf
                    <div class="col-12">
                    ...
                    <div class="col-12">
                      ...
                      <div class="invalid-feedback">Entrer l'adresse email!</div>
                    </div>

                    <div class="col-12">
                      <label for="password" class="form-label">Mod de passe</label>
                    ...
                    <div class="col-12">
                      <p class="small mb-0">J'ai deja un compte? <a href="/">Se connecter</a></p>
                    </div>
                  </form>
